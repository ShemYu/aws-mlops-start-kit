...
def register_model(role, region, evaluate_result_uri, model_info, model_path, model_instance, model_uri, register_info, model_approval_status):
    ...
    return RegisterModel( # 封裝註冊模型相關資訊
        ...
        inference_instances=["ml.t2.medium", "ml.m5.xlarge"], # realtime inference AWS 機器定義
